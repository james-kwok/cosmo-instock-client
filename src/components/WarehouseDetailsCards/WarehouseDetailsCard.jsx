    ...
    <div className="Warehouse_detail_container">
        ...
        <div className="Warehouse_detail_container__form">
            ...
            <div className="Warehouse_detail_container__form__box">
                <label htmlFor="warehouseName" className="Warehouse_detail_container__form__box--label">Warehouse Name</label>
            ...
            <div className="Warehouse_detail_container__form__box">               
                <label htmlFor="StreetAddress" className="Warehouse_detail_container__form__box--label">Street Address</label>
            ...
            <div className="Warehouse_detail_container__form__box"> 
                <label htmlFor="City" className="Warehouse_detail_container__form__box--label">City</label>
            ...
            <div className="Warehouse_detail_container__form__box"> 
                <label htmlFor="Country" className="Warehouse_detail_container__form__box--label">Country</label>
